...
// MPFR 2.4.0 Specifics
    ...
    friend const mpreal mod (const mpreal& x, const mpreal& y);//RL, mp_rnd_t rnd_mode = mpreal::get_default_rnd()); // Modulus after division
#endif
...
inline const mpreal mod (const mpreal& x, const mpreal& y)//, mp_rnd_t rnd_mode) RL
{
    //RL(void)rnd_mode;
